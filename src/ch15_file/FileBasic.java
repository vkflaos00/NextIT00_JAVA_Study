...
public class FileBasic {
	...
	public static void main(String[] args) {
		...
		// 폴더 만들기
		File today = new File("/home/ssam/today");
		...
		// 파일 만들기
		// /home/ssam/today 안에 test.txt 파일 만들기
		File test = new File("/home/ssam/today/test.txt");
		...
		for(int i = 0; i < stuArray.length; i++) {
			File temp = new File("/home/ssam/today/" + stuArray[i]);
			temp.mkdir();
		}
