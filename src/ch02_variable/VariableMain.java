...
//		MATH_PI = 4.23;
		...
		// String 은 기본 타입이 아닌 참조 타입이므로
		// null 값을 가질 수 있다.
		// 참조 타입의 변수를 객채(instance)라고 부른다.
...
//		System.out.println(strNull.concat("채우기"));
		...
		// int 곱하기 double은 double 타입으로 자동 형 변환 된다.
		double mulResult = intVal * doubVal;
		
		// int 곱하기 float을 해도 float 타입으로 자동 형 변환 된다.
		float floatRst = intVal * 1.23f;
		
		// int 20000이 long 타입으로 자동 형 변환 되어 담긴 것
		long longVal = 20000;
		...
		// 강제 형 변환
		// (타입) 값
		// 형 변환이 가능한 경우에 대해, 해당 값이 괄호 안 타입으로 
		// 변환 된다.
		...
		// 많이 하는 실수
		double result = 10 / 3 ;  // 3.333333
		System.out.println(result);  // 3.0
		
		// result가 3.33333으로 출력되도록 바꿔보세요
		result = (double)10 / 3 ;
		...
		// 문자열을 정수 타입으로 형 변환
		// Integer.parseInt(숫자 문자열) !!!!! 자주 사용
		int intNum = Integer.parseInt(strNum);
		System.out.println(intNum + 2);
		
		// 정수 타입을 문자열로 형 변환
		// Integer.toString(숫자) 안 중요함 잘 안 씀
		String strCast = intNum + ""; // 이걸로 대체하기 때문
