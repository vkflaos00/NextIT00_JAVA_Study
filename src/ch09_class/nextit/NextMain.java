...
public class NextMain {
	...
	public static void main(String[] args) {
		...
		// 여러분들의 짝꿍에 대해 객체로 만들어 주시는데
		// 레벨과 경험치는 1과 0으로 고정해서 만들어보세요
		// 2명 이상 만들어 보기
		
		NextStudent hyeongon = new NextStudent("현곤", 29, 1, 0);
		NextStudent chanung = new NextStudent("찬웅", 31, 1, 0);
		NextStudent jonghyen = new NextStudent("종현", 33, 1, 0);
		NextStudent jinyeong = new NextStudent("진영", 27, 1, 0);
		...
		stuList.add(jihye);
		stuList.add(junha);
		stuList.add(jinyeong);
		stuList.add(jonghyen);
		stuList.add(chanung);
		stuList.add(hyeongon);
		stuList.add(junho);
		stuList.add(taeyoon);
		...
		// 레벨을 이용하여 정렬하기
		// Collections.sort는 정렬 기준을 모르면 에러가 난다.
